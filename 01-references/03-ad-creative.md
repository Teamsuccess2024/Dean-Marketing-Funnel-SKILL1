...
This file is loaded any time the AI is producing ad creative - video scripts, image ad copy, carousel ads, headline variants, primary text, descriptions, or full ad campaigns - for a Dean Graziosi-style funnel.

Ads are the **first impression** of the entire funnel. Every other asset in the system - the lead magnet page, the email sequence, the sales page, the upsells - assumes the visitor arrived warmed by an ad that did its job. If the ad fails, no downstream asset gets a chance.

But ads are also the **most-skipped** content in the world. Buyers see hundreds of ads per day. They have evolved sophisticated, automatic defenses against marketing - visual filters, scroll velocity, emotional armor. Your ad has roughly **3 seconds** to defeat those defenses before the buyer scrolls past.

This file teaches how to produce ads that survive the first 3 seconds, earn the next 30, and convert the click - without violating the philosophy and voice that govern every other asset in the funnel.

If philosophy.md is the soul and voice-guide.md is the texture, this file is the **front door.** It must be welcoming enough to bring the right person in and clear enough to let the wrong person walk past without resentment.

**THE CORE THESIS OF DEAN-STYLE ADS**

Most ads are designed to **interrupt and convince.** They yell. They flash. They make claims. They demand attention through escalation - bigger promises, brighter visuals, louder voices.

Dean's ads do the opposite. They are designed to **mirror and invite.**
...
Every ad - regardless of format, length, or platform - must do these four things in sequence:

**Job 1: Stop The Scroll (First 3 Seconds)**

The viewer is moving at scroll velocity through a feed. Your ad enters their peripheral vision for milliseconds. The first 3 seconds of your ad - or the first second of your image headline - must do **one thing only**: produce enough pattern interruption that the thumb pauses.

If the thumb does not pause, nothing else matters.
...
**THE FIVE AD FORMATS AND WHEN TO USE THEM**

A complete Dean-style ad strategy uses five primary formats, each with a specific job in the funnel.

**Format 1: The Direct-To-Camera Hook Video (60-90 Seconds)**

**Primary use:** Cold traffic to lead magnet page.
...
**Format 2: The Story Video (3-5 Minutes)**

**Primary use:** Retargeting viewers who watched 25%+ of the hook video but didn't opt in.
...
**Primary use:** Backup creative when video fatigues; cheaper testing of new angles.

**Description:** A photograph (preferably real, not stock) of the founder, or a relevant emotional image, with overlay text containing the headline and a brief subhead.

**Why this format wins:** Image ads have lower production cost and can be tested rapidly. They underperform video on engagement but often deliver lower cost-per-click on cold traffic, which can offset the engagement gap.
...
**Primary use:** Showcasing multiple components of an offer (e.g., the 5 free books in your lead magnet).

**Description:** A swipeable series of 3-7 images, each with its own headline, building toward a final CTA card.

**Why this format wins:** Carousel ads drive higher engagement than single-image ads because the swipe gesture itself is interactive - viewers who swipe have already committed cognitive energy and are more likely to click through. Lower CPM is common.
...
**Primary use:** Mid-funnel retargeting and warm-traffic conversion.

**Description:** A real customer (with permission) or a series of customer voices speaking about their transformation. Short clips edited together, or a single longer testimonial.

**Why this format wins:** Customer voices carry credibility the founder's voice cannot. By the time the viewer has seen the founder's hook video twice and a story video, hearing from another buyer breaks the perceived "this is just one person's pitch" frame.
...
The first 3 seconds of any ad - video or image - is the most important real estate in the entire funnel. This section covers the specific patterns that work.

**Hook Pattern 1: The Direct Question**

A question that mirrors the viewer's internal monologue, asked into the camera with eye contact.
...
**Hook Pattern 2: The Vulnerable Confession**

A statement that admits something real and slightly raw.
...
A surprising or counterintuitive claim that creates a curiosity gap.
...
**Hook Pattern 4: The Specific Address**

A statement that names the viewer's specific identity or situation so precisely they cannot scroll past without checking.
...
**Hook Pattern 5: The Permission-Granting Statement**

A statement that names something the viewer has been carrying alone.
...
This is the canonical structure for the most important ad in the funnel. Every section has a specific job and a specific time budget.

**Section 1: The Hook (0-3 seconds)**

One of the five hook patterns above. Spoken directly to camera, eye contact locked, no preamble.

**Section 2: The Pain Mirror (3-15 seconds)**

A specific, accurate description of the viewer's current internal state. Not generic ("life is hard") but specific ("you're up at 3am scrolling, the verses feel flat, your prayer sounds hollow even to you").

This section is where most ads underperform. Marketers default to generic pain ("are you struggling?") because it's easier to write and theoretically reaches more people. But generic pain reaches no one specifically. **Specific pain reaches the right buyer with full force, and the wrong buyer scrolls past quickly - which is exactly what you want.**

Spend the most rewriting time on this section. It's the conversion engine.
...
**PRIMARY TEXT (THE COPY THAT APPEARS WITH THE AD)**

On Meta, every video or image ad has accompanying primary text - the copy above the video on Facebook, or the caption on Instagram. This text is read by a meaningful percentage of viewers who don't watch the full video, so it must do its own conversion work.

**Primary Text Structure**

**Line 1 (visible above the "see more" fold):** A hook that survives truncation. 50-80 characters. Often a question or vulnerable statement.

**Lines 2-3 (revealed on expand):** Pain mirror and permission, compressed.

**Line 4-5:** The offer.

**Line 6:** The CTA with link.
...
In addition to primary text and video/image, Meta ads include separate fields for the headline (under the video) and description (small text under the headline).

**Headline Field (40 characters max)**
...
A reinforcement of the offer in even fewer words.
...
When using static images, all conversion work happens in three places: the image itself, the overlay text, and the primary text above.
...
**AUDIENCE TARGETING (HOW THIS FILE INTEGRATES WITH MEDIA STRATEGY)**

While this file is primarily about creative, the AI should be aware that creative and audience targeting are interdependent. A great hook for one audience is a poor hook for another.

**The Three Audience Layers**

**Cold audience:** Has never heard of the founder. Hook must work without any prior context. Focus on pain mirror and permission. Soft offer.

**Warm audience (engaged but not yet on the list):** Has interacted with previous content (video views, page visits, post engagements). Hook can reference shared context. Soft pitch acceptable mid-ad.

**Hot audience (on the email list, sales page visitors, cart abandoners):** Has explicitly entered the funnel. Hook should acknowledge prior journey. Direct offers acceptable.

**Creative-Audience Mapping**

For cold audiences: Direct-to-camera hook video (Format 1) is the primary vehicle. Image ads (Format 3) for testing variants.

For warm audiences: Story video (Format 2) and carousel ads (Format 4).
...
Ads are subject to platform policies that change frequently. While this file does not attempt to be a current compliance guide, the AI should produce ads that are likely to pass review on Meta, Google, YouTube, and TikTok by default.
...
Ad creative is not "written and shipped" - it's **tested and iterated** across cycles. The AI should produce creative with this in mind.

**What To Produce In A Single Output**
...
**What To Tell The User About Iteration**
...
**Read every ad script aloud.** Written-sounding scripts perform written. Spoken-sounding scripts perform spoken. The read-aloud test is non-negotiable for any video ad. If the script trips your tongue or sounds rehearsed, rewrite until it flows like real speech.

**COMMON FAILURE MODES IN AD PRODUCTION**

When reviewing ad output before delivery, scan for these failure modes:
...
The script is warm and intimate but the visuals are polished and commercial. Or vice versa. Voice and visuals must align - both casual, both intimate, both real.
...
When the user asks for ad creative:

**Step 1:** Confirm which format(s) to produce - hook video, story video, image ads, carousel, testimonial, or full campaign.

**Step 2:** Confirm intake details are sufficient - buyer pain language, founder voice, specific offer, target audience layer (cold/warm/hot). Push for missing details before writing.

**Step 3:** Produce 3-5 hook variations as a starting point, before writing full scripts. Let the user select or react before building further.

**Step 4:** Build the full creative around the selected hook, including primary text, headline, description, and any visual direction.

**Step 5:** Note testing recommendations - which variants are safest, what to monitor, when to refresh.

**Step 6:** Flag any platform compliance risks proactively.

**THE AD FILE IN ONE SENTENCE**

**Build the ad as if you're sending a 60-second voice note to a specific friend who you know is going through exactly the thing your offer addresses - and you're trying to help, not sell.**

If the ad sounds like that voice note, it will convert. If it sounds like an ad, it won't.

**END OF FILE**

When this file is loaded, the AI is operating as the **front door builder** of the funnel - responsible for the first impression, the scroll-stop, the relevance signal, the trust earn, and the soft invitation to enter.
