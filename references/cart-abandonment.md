...
This file is loaded any time the AI is producing the cart abandonment recovery sequence - the series of emails (and sometimes retargeting ads) that triggers automatically when a buyer reaches the checkout page but leaves without completing their purchase.

Cart abandonment is the most expensive form of friction in the entire funnel. By the time a buyer has reached the checkout page, every upstream asset has already done its job: the ad earned the click, the lead magnet page captured the email, the email sequence built the trust, the sales page closed the decision. Ad spend has been deployed, attention has been earned, and the buyer has demonstrated, by reaching the checkout page, that **they wanted to buy.**
...
If checkout-page.md is the moment of reach, this file is **the gentle hand on the shoulder afterward** - checking in, removing friction if friction is what stopped the purchase, and gracefully releasing the buyer if it isn't.
...
Dean's framing is different: **most cart abandonment is friction, not rejection.**
...
This is the structural principle: **the cart abandonment sequence is customer service first, marketing second.** A genuinely helpful sequence converts better than a hard-selling one because it accurately matches the abandoner's actual psychological state.

**THE FIVE PRINCIPLES OF CART ABANDONMENT ARCHITECTURE**
...
The links in the abandonment emails must take the buyer **directly back to checkout with their information already filled in.** If the buyer has to re-enter their email, re-find the product, re-read the sales page, re-enter their card information, recovery rates collapse. Most modern checkout platforms support this natively through abandonment-link tokens; if your platform doesn't, switch platforms before launching.

**Principle 3: Keep The Sequence Short**

The full sequence should be **3 emails over 48 hours, then stop.** Longer sequences produce diminishing recovery and accelerating trust damage. After 48 hours, the buyer has either come back or genuinely chosen not to - continuing to email them past that point reads as harassment and damages the long-term relationship.

**Principle 4: Honor The Decline**

Every email in the sequence must include a graceful decline path - either an unsubscribe link, a "not for me" reply option, or a clear sentence releasing them from any obligation. Buyers who feel respected when they decline often re-engage with the funnel weeks or months later. Buyers who feel hounded never come back.

**Principle 5: Real Urgency, Not Manufactured Urgency**

If a deadline is referenced in the abandonment sequence, it must be a **real deadline.** A bonus that genuinely expires, a price that genuinely increases, an inventory that's genuinely limited. Manufactured urgency ("Your cart expires in 30 minutes!" when there's no such mechanic) damages trust the moment the buyer realizes the deadline isn't real - which they almost always do, because they receive identical emails the next time they abandon.

These five principles are non-negotiable. Sequences that violate any of them produce short-term gains and long-term damage. Sequences that honor all five compound trust over time and produce stable, scalable recovery rates.

**THE THREE-EMAIL SEQUENCE STRUCTURE**

The Dean cart abandonment sequence consists of three emails over 48 hours, each doing a specific job:

**Email 1 (sent 1 hour after abandonment):** The concerned-friend check-in. Asks if something went wrong. Removes friction. Routes back to checkout if the buyer wants to complete.

**Email 2 (sent 24 hours after abandonment):** The reframe. Tells a brief story or shares a customer testimonial that addresses common hesitations. Soft re-pitch, not aggressive.

**Email 3 (sent 48 hours after abandonment):** The respectful close. References any genuine deadline, makes the final clear ask, and gracefully releases the buyer if they're not going to convert.

After Email 3, the buyer either completes their purchase or moves out of the abandonment sequence and back into the standard email nurture sequence. They should not receive additional abandonment emails. They should not receive aggressive follow-up. They simply continue receiving the regular long-term nurture content like any other engaged subscriber.

**EMAIL 1: THE CONCERNED-FRIEND CHECK-IN**

Sent 1 hour after the buyer reaches the checkout page without completing. This is the highest-impact email in the sequence - it does most of the recovery work, often producing 60-70% of total sequence recovery on its own.

**Strategic Purpose**

Email 1 exists to address the largest segment of abandoners: those who experienced friction (technical issue, distraction, hesitation) rather than rejection. The email assumes good faith on the buyer's part - assumes they wanted to buy and something got in the way - and offers help.

This assumption matters because it determines the email's voice. A "you're missing out!" email assumes rejection and signals desperation. A "did something go wrong?" email assumes friction and signals service. The latter outperforms the former by a wide margin.

**Subject Line**

The subject line is the most important single element in the entire abandonment sequence. It determines whether the email gets opened, which determines whether any recovery happens at all.
...
The preview text reinforces the personal-note tone of the subject line.
...
Email 1 should be **150-250 words.** Longer emails read as marketing campaigns; shorter emails miss the friction-removal opportunity. The length should be conversational - what a real person would write to check in on a real friend.
...
Sent 24 hours after abandonment. By this point, buyers who would have completed due to simple friction (Email 1's target) have either completed or genuinely declined. Email 2 targets a different segment: buyers who hesitated due to a specific psychological objection - price, timing, doubt about the product fitting their situation.
...
The subject line should hint at the story without spoiling it.
...
Email 2 should be **300-500 words.** Slightly longer than Email 1 because the story requires room to breathe. But still readable in 60-90 seconds.
...
Sent 48 hours after abandonment. This is the final email in the sequence. By this point, buyers who would have completed due to friction or specific hesitation have either completed or genuinely chosen not to. Email 3 targets the remaining decision-makers: buyers who are on the fence and need a clear, respectful prompt to make a final call.

**Strategic Purpose**

Email 3 has two simultaneous jobs that must be done in balance:

**Job 1:** Make a clear final ask, with real urgency if real urgency exists.
...
The subject line should signal closure, not desperation.
...
Email 3 should be **250-400 words.** Brief enough to read quickly, complete enough to close the sequence respectfully.
...
The sequence's effectiveness depends heavily on getting the timing right.

**Trigger Point**

The sequence triggers when a buyer reaches the checkout page (page view fired) without completing the purchase (purchase event not fired) within a defined window - typically 30-60 minutes. The 30-60 minute window matters: triggering immediately after page exit catches buyers who simply got distracted and might come back on their own; waiting longer than 60 minutes loses the "still warm" psychological window that makes Email 1 effective.
...
Sent 24 hours after Email 1. The 24-hour window allows the buyer time to genuinely consider their decision without feeling hounded. It also creates natural narrative spacing - the story-based reframe lands better when there's been time for the buyer's hesitation to fully form.

**Email 3 Timing**

Sent 24 hours after Email 2 (so 48 hours after the original abandonment). This is the sequence's terminal point. After Email 3, the buyer exits the abandonment sequence regardless of whether they completed.

**Tag and Sequence Management**
...
Cart abandonment recovery is most effective when email is paired with retargeting ads on the platforms the buyer uses (typically Meta and Google).

**The Combined Approach**

**Email handles direct, personal communication** with buyers who opted into the email list. The voice is intimate, the recovery rate is high (15-30% of abandoners), and the cost is essentially zero.
...
The retargeting ad approach is detailed in retargeting.md, but the abandonment-specific principles are:
...
**The frequency should be capped.** No buyer should see the same retargeting ad more than 5-7 times in a 7-day period. Higher frequency creates negative brand association.

**VOICE CALIBRATION FOR ABANDONMENT EMAILS**

The voice rules from voice-guide.md apply, with these specific adaptations:

**Tone of concern, not pursuit.** The abandonment sequence operates in a delicate emotional register. The buyer didn't complete; the seller is following up. The default emotional tone of "follow-up" can easily slide into pressure or desperation. The Dean voice holds it as concern - the way a friend would check in if they noticed you started something and didn't finish.
...
The cart abandonment sequence does not stand alone. It receives buyers from the checkout page and routes them to multiple downstream paths.

**Inbound from checkout page:** The sequence triggers when a buyer reaches checkout but doesn't complete. The trigger must be reliable - every buyer who matches the criteria should enter the sequence, and no buyer who doesn't match should enter it accidentally.

**Outbound for completers:** Buyers who complete their purchase during the sequence (clicking through from any of the three emails) immediately exit the abandonment sequence and enter the post-purchase sequence (see post-purchase.md). The transition must be clean - they should not receive Email 2 or Email 3 after completing.

**Outbound for non-completers:** Buyers who don't complete after 48 hours exit the abandonment sequence and return to the standard long-term nurture sequence (see email-sequences.md, the long-term nurture section). They should not receive aggressive follow-up. They should simply continue receiving regular nurture content as if the abandonment hadn't happened.

**Outbound for unsubscribers:** Buyers who explicitly request to unsubscribe (whether through the unsubscribe link or by replying with "unsubscribe") should be removed from all future emails immediately. Honoring unsubscribe requests promptly preserves long-term reputation.

**Inbound from retargeting clicks:** Cart abandoners who click on retargeting ads should land back on the sales page or directly on the checkout page (depending on ad creative). If they then complete a purchase, they should be properly attributed in the analytics - credit going to the retargeting ad rather than (or in addition to) the original ad that drove the initial visit.

**Pixel and tracking integration:** Each email open, click, and resulting completion should fire appropriate tracking events for the email platform and ad platforms. Without this tracking, optimization of the sequence over time becomes impossible.

**A COMPLETE THREE-EMAIL SEQUENCE EXAMPLE**

The following is a complete, ready-to-deploy example of a Dean-style cart abandonment sequence for the Purpose In Your Pain bundle.

**EMAIL 1 - Sent 1 Hour After Abandonment**

**Subject:** Did something go wrong?

**Preview:** If anything broke, I want to fix it.

Hey - I noticed you started to grab the bundle but didn't finish.

Did something go wrong on your end?
...
**Subject:** Mark almost didn't buy either

**Preview:** Three months ago she told me she almost didn't pull the trigger...
...
She read the main book in two evenings. The other nine sat on her Kindle for the next four months - and during that time, she pulled three of them off the shelf at exactly the moments she needed them.
...
**Preview:** Just want to make sure you have the choice...

This is the last email I'll send about your order. After tonight, I'll let it go either way.

You started the order two days ago and didn't finish. I sent a check-in. I sent a story. And now I just want to make sure you have the choice clearly in front of you, one more time, before this email sequence wraps up.
...
That's the complete sequence. Three emails, roughly 1,200 words total, deployed over 48 hours. Every principle honored. Nothing extraneous.

This sequence, paired with retargeting ads, can recover 15-30% of cart abandoners in most niches - which on a meaningful funnel translates to substantial recovered revenue at near-zero marginal cost.

**COMMON FAILURE MODES IN CART ABANDONMENT PRODUCTION**

When reviewing cart abandonment sequence output before delivery, scan for these failure modes:
...
Email 1 jumps straight to re-pitching the offer instead of addressing the most common abandonment reason (technical issues, distraction). The sequence misses the largest segment of recoverable abandoners.

**Failure Mode 3: Manufactured Urgency**

The sequence references deadlines that don't actually exist ("Your cart expires in 30 minutes!" when there's no actual mechanism). Short-term gain, long-term trust damage.

**Failure Mode 4: Discount-Driven Recovery**

The sequence offers a discount to incentivize completion. This trains buyers to abandon every cart and wait for the discount, destroying margin permanently.

**Failure Mode 5: Sequence Too Long**

The sequence runs 5-7 emails over 7-14 days. Recovery rates plateau after Email 3, and continued emails damage the long-term relationship. The sweet spot is 3 emails over 48 hours.

**Failure Mode 6: Missing Decline Path**

No email in the sequence offers a graceful unsubscribe or "not for me" option. Buyers who would have declined gracefully decline angrily, increasing unsubscribe rates and brand damage.

**Failure Mode 7: Voice Drift From The Funnel**

The abandonment emails sound corporate and aggressive while the rest of the funnel sounded warm and intimate. The buyer experiences whiplash and trust drops.

**Failure Mode 8: Missing Direct-To-Checkout Link**

The emails link to the sales page instead of directly back to checkout with cart pre-populated. The buyer has to re-traverse the funnel, and many don't.

**Failure Mode 9: Not Triggered Properly**

The sequence doesn't fire reliably - some abandoners enter, others don't, due to tracking misconfiguration. Recovery underperforms because most abandoners never receive the emails.

**Failure Mode 10: Continues After Completion**

Buyers who complete during the sequence still receive Email 2 and Email 3. The seller looks careless, and trust is damaged.

**Failure Mode 11: Generic Story In Email 2**

The story in Email 2 is generic ("a happy customer was hesitant too!") rather than specific (named person, specific circumstances, specific resolution). Generic stories don't reframe - they signal marketing.

**Failure Mode 12: Pressure In Email 3**

Email 3 leans into desperation ("THIS IS YOUR LAST CHANCE!") instead of respect ("either way is okay"). The closing email damages the long-term relationship even when it doesn't recover the sale.

**Failure Mode 13: No Reply Path**

The sequence doesn't invite or honor replies. Buyers who would have completed if their question was answered never get the chance to ask.

**Failure Mode 14: Continues To Unsubscribers**

Buyers who replied with "unsubscribe" or "not for me" still receive subsequent emails. Reputation damage and potential platform compliance issues.
...
**OUTPUT INSTRUCTIONS WHEN BUILDING CART ABANDONMENT SEQUENCES**

When the user asks for a cart abandonment sequence to be built:

**Step 1:** Confirm intake details - what is the product, what is the price, what is the buyer's likely hesitation profile, what specific story or testimonial is available for Email 2, what genuine deadline (if any) exists for Email 3. Push for missing details before writing.

**Step 2:** Confirm voice continuity - the abandonment sequence must sound like the same human who wrote the sales page and checkout page. If the user hasn't provided sufficient voice context, ask for it before writing.

**Step 3:** Confirm timing parameters - 1 hour, 24 hours, 48 hours is the standard. If the user wants different timing, push back and explain why the standard timing is optimal.

**Step 4:** Build all three emails in full as a complete sequence. Don't write only Email 1 and let the user piece together the rest - the sequence's effectiveness depends on the arc across all three emails.

**Step 5:** After delivery, briefly note (a) what to monitor (recovery rate, with 15-30% being the target range), (b) what to A/B test if recovery is weak (Email 1 subject line first, then Email 2 story, then Email 3 close), and (c) the technical integrations required (sequence triggering, completion-stops-sequence logic, unsubscribe handling, retargeting ad coverage).

**Step 6:** Flag any technical requirements the user may not have considered - abandonment cart link tokens, sequence-stop logic, tracking pixel integration, retargeting audience setup.

**Step 7:** Confirm the post-sequence routing - what happens to buyers who don't complete? They should return to the standard long-term nurture sequence, not be hammered with additional abandonment emails.

**THE CART ABANDONMENT SEQUENCE IN ONE SENTENCE**

**Build the cart abandonment sequence as a brief, helpful, three-email check-in that assumes friction rather than rejection - leading with concern, offering friction removal, sharing one specific story, making one respectful final ask, and gracefully releasing buyers who genuinely don't want to complete - so the sequence recovers the friction-driven abandoners without damaging the long-term relationship with the rejection-driven ones.**

If the sequence does that, it will recover 15-30% of cart abandoners at near-zero marginal cost - one of the highest-ROI assets in the entire funnel. If the sequence drifts into hype-driven, discount-laden, multi-email harassment territory, it will produce short-term recovery gains and long-term reputation damage that takes years to rebuild.

**END OF FILE**

When this file is loaded, the AI is operating as the **gentle hand on the shoulder** of the funnel - responsible for the recovery sequence that runs at the most expensive abandonment point in the entire system, where every upstream investment (ad spend, attention, trust-building) has already been deployed and the buyer has demonstrated, by reaching the checkout page, that they wanted to buy.

The cart abandonment sequence is not a separate marketing campaign. It is the **continuation of customer service** that began with the ad and developed through every subsequent funnel asset. Every element in this file exists to make that continuation feel natural, helpful, and respectful - so that buyers who experienced friction can complete their purchase with minimal effort, and buyers who genuinely changed their mind can decline gracefully without burning the long-term relationship.
